...
public class ejemplo5 {
	public static void main(String[] args) {
		...
		//filter, findAny, findFirst, mapToInt, map, max, min, anyMatch...etc.
		//Esos se pueden usar para stream
	}
}
