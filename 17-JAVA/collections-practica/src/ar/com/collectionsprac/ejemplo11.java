...
public class ejemplo11 {
	public static void main(String[] args) {
		...
		//Como es un Optional, puede tener o no un valor
		if(alumno.isPresent()) {//Si el Optional alumno tiene un valor, ejecuta el codigo. En cambio con metodo isEmpty es si no tuviese valor
			System.out.println(alumno.get());
		}
		
		//Para este tipo de ejercicios en los que obtenemos datos unicos
		//Tal vez es mejor usar Map. Primero tenemos que hacerlo en Cursada asi cada vez que se crea una, tambien se crea un Map
		//Ahora que hicimos eso, podemos hacer lo mismo del ejemplo de arriba pero con Map
