...
public class OrdenarLista {
	...
	*/	/////////////////////////////////////////////////////////////////////
	...
	/*	class NumeroDeCuentaComparator implements Comparator<Cuenta>{//Esta es una interfaz que tenemos que implementar si o si. Viene de java.util.
		...
		//NOTAAAAAA: Para ver este ejemplo pero mas resumido gracias a java, vease el archivo TestLambda.java
	*/	
...
///////////////////////		
	...
	/*	class TitularDeCuentaComparator implements Comparator<Cuenta>{//Tambien queremos comparar Cuentas
		...
		//Ademas de Functional Interface, tambien pueden haber Functional Object, un objeto que creamos para encapsular una función o método. 
...
//Si utilizo las funciones anonimas, me ahorro el trabajo de implementar las clases. Eso no quiere decir que java no lo haga internamente. En realidad, java crea e implementa una clase en el momento de compilar y la llama en la funcion anonima.
