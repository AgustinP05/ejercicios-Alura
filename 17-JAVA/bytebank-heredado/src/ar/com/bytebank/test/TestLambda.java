...
///////Ordenar por nombre		
		...
		//Imprimir como haciamos antes
		/*for(Cuenta cuenta : lista) {//ForEach para mostrar el numero de cuentas antes de ordenarlas
			System.out.println(cuenta);
		}*/
		
		//Para imprimirlo vamos a utilizar otro tipo de forEach para esta lista y con lambda
		lista.forEach((Cuenta cuenta) ->{
			System.out.println(cuenta);
		});//Nos pide que ingresemos un Consumer por parametro. Consumer es otra interfaz funcional.
		//Como vemos, en el parametro solo tenemos que poner el tipo y el nombre identificador para ejecutar codigo en el bloque del forEach. Entendible.
		//Incluso podria obviar el tipo, ya que java sabe que lo unico que hay dentro de la lista son cuentas.
